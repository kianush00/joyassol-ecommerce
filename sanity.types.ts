...
// Query: *[_type == "category"][0...$quantity] | order(name asc)
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    '*[_type == "category"][0...$quantity] | order(name asc)': CATEGORIES_QUERY_RESULT;
    '*[_type == "product" && name match $searchParam] | order(name asc)': PRODUCT_SEARCH_QUERY_RESULT;
    "*[_type == 'product' && references(*[_type == \"category\" && slug.current == $categorySlug]._id)] | order(name asc)": PRODUCTS_BY_CATEGORY_QUERY_RESULT;
